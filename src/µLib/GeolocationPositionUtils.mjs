 ...
 * @method DistanceTo
 * @instance
 * @param {GeolocationPosition} _toGeoPos        The GeolocationPosition to get the distance to.
 ...
 * @method Move
 * @instance
 * @param {number} _mLat        Latitude meters to move.
 * @param {number} _mLng        Longitude meters to move.
