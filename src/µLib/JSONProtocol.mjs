...
export default class JSONProtocol {
	 ...
	 * @param {boolean} [_forceReload=false]   		True, if the configuration should be reloaded from the server.
	 * @return {Promise}	A promise which resolves with the loaded protocol definition.
	 */
